...
const Description = () => {
    return (
        <div className='bg-white rounded-lg p-6 mt-4'>
            <h2 className='text-3xl font-bold mb-2'>About this Place</h2>
            <span className='text-sm py-1 px-2 bg-[#ebebeb] rounded'>History and Additional information</span>
            <p className='text-justify mt-3'>Contrary to popular belief, Lorem Ipsum is not simply random text. It has roots in a piece of classical
